package com.cat.limit.aspect;

import com.cat.limit.annotation.LimitCat;
import com.cat.limit.annotation.LimitCats;
import com.cat.limit.service.LimitCatException;
...
public class LimitCatsAspect {
    ...
    @Pointcut("@annotation(com.cat.limit.annotation.LimitCats) || @annotation(com.cat.limit.annotation.LimitCat)")
